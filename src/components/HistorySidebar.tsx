...
export function HistorySidebar({ sessionId, onLoadHistory, isOpen, onToggle }: HistorySidebarProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 left-0 h-screen z-40 transition-all duration-300 ease-in-out bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 ${isOpen ? "w-80 sm:w-96" : "w-0"
          } overflow-hidden`}
      >
        {/* Sidebar Content */}
